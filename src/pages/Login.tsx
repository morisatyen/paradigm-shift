...
const Login = () => {
  const [email, setEmail] = useState("museum@demo.com");
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-card">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center gap-2 mb-8">
            <svg preserveAspectRatio="xMidYMid meet" data-bbox="0 6.44 781.71 97.05" viewBox="0 6.44 781.71 97.05" xmlns="http://www.w3.org/2000/svg" style={{height:'24px', width:'150px'}}>
              <g>
