...
const Reaccessioning = () => {
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-muted-foreground text-sm mb-8">7-step process for artwork tokenization</p>
      ...
      <div className="glass-card rounded-xl p-8 max-w-2xl">
        <h3 className="font-semibold text-foreground mb-1">Step {step + 1}: {STEPS[step].title}</h3>
